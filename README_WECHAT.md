...
{
  _id: string,              // 自动生成
  userId: string,           // 用户 ID（可为空，用于密钥验证）
  isAdmin: boolean,         // 是否为管理员
  phoneNumber: string,      // 管理员密钥（可选）
...
{
  userId: null,
  phoneNumber: "13800138000",  // 替换为管理员密钥
  isAdmin: true,
  verifiedAt: null
}
```
